...
var ProductsController = function () {
    ...
    var ProductsController = _classThis = /** @class */ (function () {
        ...
        ProductsController_1.prototype.getProducts = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.productService.getAllProducts()];
                });
            });
        };
        ...
        ProductsController_1.prototype.getProductById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.productService.getProductById(+id)];
                        case 1:
                            product = _a.sent();
                            if (!product) {
