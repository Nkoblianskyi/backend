...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(prisma, // PrismaService для роботи з базою
        jwtService) {
            this.prisma = prisma;
            this.jwtService = jwtService;
        }
        // Функція реєстрації
        AuthService_1.prototype.register = function (email, password, role) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            user = _a.sent();
                            return [2 /*return*/, user]; // Повертається тип User
                    }
                });
            });
        };
